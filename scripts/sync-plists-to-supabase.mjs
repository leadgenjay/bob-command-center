...
const SKILLS_MAP = {
  'comms-email-check': ['gmail', 'email', 'bill'],
  'morning-briefing': ['gmail', 'calendar', 'zeus-team'],
  'comms-daily-review': ['gmail', 'email', 'calendar', 'notion', 'slack', 'bob-api'],
  'comms-calendar-preview': ['calendar'],
  'comms-birthday-check': ['calendar'],
  'comms-morning-roundup': ['gmail', 'calendar'],
  'content-morning-research': ['content-research', 'content-report', 'apify'],
  ...
  'infra-quick-check': ['zeus', 'n8n-leadgenjay', 'n8n-nextwave'],
  'infra-health-report': ['zeus'],
  'infra-error-logs': ['zeus', 'n8n-leadgenjay', 'n8n-nextwave'],
  'infra-secret-scan': [],
