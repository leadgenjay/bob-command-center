...
category: "Scripting"
tools: ["Apify MCP", "YouTube Analytics MCP", "fal.ai (thumbnails)"]
---
...
### Description
```
Line 1-3: Summary with primary keyword (visible before "Show More")
...
About Lead Gen Jay:
Cold email, AI automation, and lead generation strategies.
Join 2,500+ members: [AIA link]
...
1. RESEARCH  -> MANDATORY — Apify scrape top 5-10 videos on topic
...
2. ANALYZE   -> MANDATORY — Gap analysis informed by research
